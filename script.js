...
const databaseUjian = [
   // Contoh IPS: Kelas 7A & 7B Link sama (Guru A), Kelas 7C Link beda (Guru B)
    ...
    { tingkat: ["8A", "8B", "8C"], mapel: "Bahasa Inggris", link: "https://forms.gle/LinkIPS_GuruA", tgl: "2026-06-03", durasi: 120, token: "IPSJAYA" },
    ...
    { tingkat: ["8A"], mapel: "IPA", link: "https://forms.gle/uTBkYMzcexhttwHH9", tgl: "2026-06-05", durasi: 120, token: "PSATIPA8BC26" },

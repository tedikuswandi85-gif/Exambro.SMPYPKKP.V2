...
const databaseUjian = [
   // Contoh IPS: Kelas 7A & 7B Link sama (Guru A), Kelas 7C Link beda (Guru B)
    ...
    { tingkat: ["7A", "7B", "7C"], mapel: "IPA", link: "https://forms.gle/3ZiAZa9jC3EXYKEj6", tgl: "2026-06-05", durasi: 90, token: "BISMILLAHIPALULUS" },
    ...
    { tingkat: ["8A", "8B", "8C"], mapel: "Matematika", link: "https://docs.google.com/forms/d/e/1FAIpQLSfcgWckXWfByn1YXDQ26daB4H1fUuk2Yd8HIfS7uOF63ADSyg/viewform?usp=publish-editor", tgl: "2026-06-04", durasi: 90, token: "PSAT2026" },
